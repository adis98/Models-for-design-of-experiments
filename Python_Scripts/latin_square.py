...
print('tot_rows: ',total_rows,'tot_cols: ',total_cols,'tot_treats: ',total_treats)
...
ss_error = ss_total - ss_treats - ss_cols - ss_rows
print('ss_total: ', ss_total,'ss_rows: ',ss_rows,'ss_cols: ',ss_cols,'ss_treats: ',ss_treats,'ss_error: ',ss_error)
mss_treats = ss_treats/(n-1)
mss_cols = ss_cols/(n-1)
mss_rows = ss_rows/(n-1)
mss_error = ss_error/((n-2)*(n-1))

print('mss_treats: ',mss_treats,'mss_cols: ',mss_cols,'mss_rows: ',mss_rows,'mss_error: ',mss_error)
f_stat_treats = mss_treats/mss_error
f_stat_cols = mss_cols/mss_error
f_stat_rows = mss_rows/mss_error

print('f_treats: ',f_stat_treats,'f_cols: ',f_stat_cols,'f_rows: ',f_stat_rows)
